...
#include <memory>
#include "../src/menu/menu_button.h"
...
QT_MOC_LITERAL(1, 11, 14), // "change_content"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 2) // "id"

    },
    "MenuButton\0change_content\0\0id"
};
...
void MenuButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->change_content((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MenuButton::change_content)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MenuButton::change_content(int _t1)
{
